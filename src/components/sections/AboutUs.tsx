...
export default function AboutUs() {
  return (
    <div className="container mx-auto border-y-2 border-brand2 py-10" id="aboutUs">
        ...
        <div className="w-full md:w-1/2 px-4">
          <div>
            ...
            <p className="text-gray-600 text-md leading-6 mb-6">
              Somos uma equipe dedicada a transformar a maneira como você acessa
              informações de produtos. Nossa aplicação foi criada para ser uma
              ferramenta simples e eficaz, capaz de decifrar códigos de barras e
              fornecer dados completos em poucos segundos.
            </p>
            <p className="text-gray-600 text-md leading-6 mb-6">
              Acreditamos que a tecnologia deve ser acessível a todos, por isso
              oferecemos uma solução gratuita e confiável. Nossa missão é
              facilitar o dia a dia de consumidores e empresas, ajudando você a
              tomar decisões rápidas e informadas enquanto economiza tempo e
              recursos.
            </p>
            <a
              href="#"
            ...
            <div className="flex items-start mb-6">
              ...
              <div className="ml-6">
                ...
                <p className="text-gray-600 text-sm leading-6">
                  ...
                  garantir que você tenha uma experiência incrível e funcional.
                </p>
              </div>
            </div>
            <div className="flex items-start mb-6">
              ...
              <div className="ml-6">
                ...
                <p className="text-gray-600 text-sm leading-6">
                  ...
                  econômica e eficiente para diferentes necessidades, sem abrir
                  mão da qualidade.
                </p>
              </div>
            </div>
